<template>
<q-card :dark="$store.state.settings.lightMode === 'true'" class="full-height" style="width: 800px; max-width: 90vw;" :class="{'dark-theme': $store.state.settings.lightMode === 'true'}">
<h1 class="lab-title q-pr-md">Coming Soon!</h1>
<!--
    <q-toolbar class="my-toolbar">
        <q-toolbar-title><span class="text-weight-bold q-pl-sm">Active Stakes</span></q-toolbar-title>
